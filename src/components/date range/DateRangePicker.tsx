  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <div className="bg-white shadow-lg rounded-lg border border-gray-200 overflow-hidden w-72 sm:w-80">
            {/* Header */}
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-2 border border-gray-300 rounded-md bg-white text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                  />
                </div>
                
                <div className="flex items-center justify-center">
                  <div className="w-8 h-0.5 bg-gray-300 relative flex items-center justify-center">
                    <FiArrowRight className="absolute text-gray-500 bg-white p-1 rounded-full" />
                  </div>
                </div>
